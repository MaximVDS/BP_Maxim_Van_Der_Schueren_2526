...
De centrale onderzoeksvraag van dit onderzoek is: \textit{``Hoe kan artificiële intelligentie worden ingezet om automatisch de (historische) open of gesloten status van Points of Interest te detecteren, en hoe kan deze aanpak zorgen voor actuelere data in locatiegebaseerde toepassingen?''}
...
Dynamische mobiliteitspatronen vormen volgens de literatuur een sterk aanvullend signaal voor statusdetectie. Omdat echte GPS-data echter niet beschikbaar was voor dit onderzoek, werd een uitbreidingsexperiment opgezet op basis van de basisinfo-dataset, met een klassebalans van 53,9\% open en 46,1\% gesloten vestigingen. Mobiliteitsdata werd per POI gesimuleerd over 26 weken op basis van de POI-levenscyclus: een stabiele fase met realistisch weekpatroon (piek op vrijdag en zaterdag), een decay-fase met lineair dalend bezoekersaantal over tien weken voor de sluiting, en een gesloten fase met nagenoeg nul bezoekers. Op POI-niveau werden drie features geaggregeerd: \texttt{gem\_bezoekers}, \texttt{std\_bezoekers} en \texttt{max\_bezoekers}.
