...
Een Point of interest (POI) verwijst naar plaatsen van belang die gedurende de dag vaak bezocht worden door mensen, waaronder restaurants, supermarkten, vervoersknooppunten, parken, cafés en toeristische attracties \autocite{Yeow2021}. Volgens \textcite{Psyllidis2022} fungeert een POI in de hedendaagse digitale context als een surrogaat voor een fysieke locatie. POI-systemen zijn cruciaal voor het verrijken van de gebruikerservaring, het mogelijk maken van gepersonaliseerde interacties en het optimaliseren van besluitvormingsprocessen in het digitale landschap \autocite{Zhang2025}. POI data speelt een cruciale rol in volgende use cases: event planning, aanbevelingen voor reizen, gewilde locaties in de vastgoedsector, optimale route naar een tankstation, een service om een winkel te zoeken en concurrentie analyse. 
...
\begin{itemize}
    \item Basisattributen: De naam van de POI, de geografische coördinaten (meestal lengte- en breedtegraad) en de categorie of het type.
    ...
    \item Dynamische en temporele attributen: Voor statusdetectie zijn met name de openingsuren en de operationele status van belang. Bovendien kunnen POI-locaties in de loop der tijd veranderen: een bedrijf kan verhuizen, een POI kan sluiten of er kan een nieuwe POI openen.
\end{itemize}
...
\begin{itemize}
    ...
    \item Decaying: De fase waarin een POI achteruitgaat of definitief gesloten wordt. Het accuraat voorspellen van deze status is in de praktijk vaak uitdagender dan het detecteren van nieuwe openingen.
\end{itemize}
