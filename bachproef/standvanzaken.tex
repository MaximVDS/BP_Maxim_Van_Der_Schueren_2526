...
% TODO
% Een POI is niet zomaar "open" of "dicht". Er zit een proces achter. Het is nuttig om te beschrijven welke statussen een winkel kan hebben:
%Planned/Under Construction: Nog niet open, maar wel al aanwezig in data.
%Active: De normale operationele status.
%Temporarily Closed: Verbouwingen, vakantie, of incidenten.
%Permanently Closed: De zaak stopt, maar het pand staat er nog.
%Churn/Rebranded: De supermarkt stopt en wordt een andere keten (bijv. een Albert Heijn die een Jumbo wordt). Dit is voor AI-modellen vaak de grootste uitdaging.
