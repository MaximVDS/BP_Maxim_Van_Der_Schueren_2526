...
Naast directe observaties kan de status van een POI worden afgeleid uit de geografische invloed die het uitoefent op de omgeving. Volgens \textcite{Wang2018} bezit elke POI een specifieke 'geo-influence' (het vermogen van een POI om bezoekers door te sturen naar andere POI's) en 'geo-susceptibility' (de mate waarin de POI bezoekers van elders aantrekt). Voor de statusdetectie van een supermarkten is dit relevant omdat deze vaak fungeren als ankerpunten met een groot geo-influence. Een plotselinge verandering in hun operationele status heeft daardoor een meetbaar  effect op de bezoekpatronen van geo-susceptibele POI's, zoals een nabijgelegen bakker of krantenwinkel.
...
Supermarkten worden beschouwd als "sociale ankers" die mensen samenbrengen en bijdragen aan de vitaliteit van een stad \autocite{Chen2026}.
