...
\subsubsection{Fase 3 – Data verzamelen en voorbereiden}
Tijdens de derde fase werd de data verzameld en voorbereid. De volledige dataset werd rechtstreeks ter beschikking gesteld door de stageplaats (Accurat BV). Deze bevat POI-informatie zoals bedrijfsnamen, openingsuren, locatiegegevens en de historische operationele status van elke POI. De dataset dekt vier landen: België, Nederland, Luxemburg en Frankrijk, en is opgebouwd uit drie gekoppelde tabellen: een hoofdtabel met basisinformatie, een historische statustabel en een tabel met de openingsuren.

De verzamelde data werd opgeschoond en gefilterd, waarbij records met een soft delete markering (\texttt{is\_deleted = 1}) en intern gereserveerde records (\texttt{is\_reserved\_poi = 1}) werden verwijderd. Daarnaast werd een uitbreidingsexperiment opgezet waarbij kunstmatig gegenereerde mobiliteitsdata werd toegevoegd aan een statische momentopname van de dataset. Het resultaat van deze fase was een dataset die klaar was voor de modeltraining en validatie.
